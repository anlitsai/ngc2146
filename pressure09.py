...
def p_shk(SNr_V):
	Pshk=1.0e-12*(E_init/1.0e51)**(17.0/14)*(n_ambi/0.01)**(-4.0/7)*(SNr_V/1.0e-13) # [erg cm^-3]
	print "remnant expanded shock P: ", Pshk
	return Pshk
# E_init [erg]
# n_ambi [cm^-3]
# SNrate_V [yr^-1 pc^-3]
# SNrate_V=SNrateate per volume
p_shk_conti=p_shk(SNr_V_conti)
p_shk_greve1=p_shk(SNr_V_greve1)
p_shk_greve2=p_shk(SNr_V_greve2)
