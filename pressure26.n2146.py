...
def surf_den_skmt99(S_CO_JyBmMS,px,as2pc,type):
	...
	print '%.1e' %sd,"[g/cm2]",'%.0f' %sd_Msunpc2,"[Msun/pc2] (z =",'%.2f' %(z_gas_pc),"pc)",'%.1e' %M_gas_Msun,"[Msun]",'%.2f' %n_kpc2,"[kpc^2]" ,type
...
print "------------"
sd=surf_den_skmt99(3.730E+03,5303,as2pc,"mbbl")
sd=surf_den_skmt99(4.1472E+02,11022,as2pc,"motf")
sd=surf_den_skmt99(1.429E+03,8437,as2pc,"motf")
sd=surf_den_skmt99(7.481E+02,4683,as2pc,"motf")
sd=surf_den_skmt99(1.327E+03,6999,as2pc,"motf")
sd=surf_den_skmt99(6.669E+02,5730,as2pc,"motf")
sd=surf_den_skmt99(7.782E+02,5161,as2pc,"motf")
sd=surf_den_skmt99(6.981E+02,5343,as2pc,"motf")
sd=surf_den_skmt99(8.036E+02,4609,as2pc,"motf")
...
sd=surf_den_skmt99(1.1243E+04,38685,as2pc,"unkown")
sd=surf_den_skmt99(1.3559E+04,30802,as2pc,"45as")
sd=surf_den_skmt99(1.3182E+04,31100,as2pc,"mdsk")
sd=surf_den_skmt99(2.054E+04,18679,as2pc,"mdsk")
sd=surf_den_skmt99(2.111E+04,18040,as2pc,"mdsk")
sd=surf_den_skmt99(4.769E+04,1577,as2pc,"0.3kpc")
sd=surf_den_skmt99(3.523E+04,3877,as2pc,"0.5kpc")
sd=surf_den_skmt99(3.356E+04,6405,as2pc,"0.8kpc")
sd=surf_den_skmt99(3.652E+04,5454,as2pc,"0.8kpc")
sd=surf_den_skmt99(3.049E+04,9394,as2pc,"1.2kpc")
sd_gas_Msunpc2=sd[0]
sd_gas=sd_gas_Msunpc2*Msun_pc2
print "sd_gas",sd_gas
sd=surf_den_skmt99(2.431E+04,12852,as2pc,"1.2kpc")
sd=surf_den_skmt99(2.139E+04,16646,as2pc,"1.6kpc")
sd=surf_den_skmt99(1.723E+04,21464,as2pc,"1.6kpc")
sd=surf_den_skmt99(1.579E+04,25693,as2pc,"2.4kpc")
sd=surf_den_skmt99(1.381E+04,30152,as2pc,"2.4kpc")
sd=surf_den_skmt99(1.466E+04,28170,as2pc,"2.4kpc")
sd=surf_den_skmt99(1.364E+04,30695,as2pc,"2.8kpc")
sd=surf_den_skmt99(1.364E+04,30695,as2pc,"tvbox;30as")
sd=surf_den_skmt99(3.085E+04,9308,as2pc,"89GHz region; 2 sigma; r=1.4kpc")
sd=surf_den_skmt99(3.095E+04,9239,as2pc,"89GHz region; 2 sigma; r=1.4kpc")
sd=surf_den_skmt99(3.252E+04,8479,as2pc,"89GHz region better; 2 sigma; r=1.4kpc")
sd=surf_den_skmt99(4.03E+04,5527,as2pc,"89GHz region; 4 sigma; r=1.2kpc(?)")
sd=surf_den_skmt99(5.035E+04,2272,as2pc,"89GHz region; 8 sigma; r=0.8kpc(?)")
sd=surf_den_skmt99(6.984E+04,176,as2pc,"0.2kpc")
sd=surf_den_skmt99(1.027E+04,42672,as2pc,"total molecular gas; 0.1 sigma")
sd=surf_den_skmt99(1.370E+04,31200,as2pc,"total molecular gas; 4 sigma")
sd=surf_den_skmt99(5.055E+04,2338,35,"n3628 ; 88GHz region")
sd=surf_den_skmt99(3.400E+04,4564,35,"n3628 89GHz region convl n2146 88GHz; 2 sigma; r=0.26kpc(?)")
