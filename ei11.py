...
print "------------------------------------"
ei_n3628=EI(5.06958E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628 core, vmekal+pow, grp, test76",0.1,0.01,0.3,0.46)
ei_n3628=EI(4.69897E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628 core, vmekal+pow, grp_2, test76",0.1,0.01,0.3,0.48)
ei_n3628=EI(5.25052E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628 core, mekal+pow, grp, test76",0.1,0.01,0.3,0.44)
ei_n3628=EI(5.96931E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628 core, mekal+pow, grp_2, test76",0.1,0.01,0.3,0.43)
ei_n3628=EI(3.53883E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628 core, raym+pow, grp, test76",0.1,0.01,0.3,0.45)
ei_n3628=EI(6.28310E-05,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC3628 halo, vmekal+pow, test76",0.1,0.01,0.3,0.372)
ei_n3628=EI(7.16039E-05,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC3628 halo, vmekal+pow, test93",0.1,0.01,0.3,0.33)

print "------------------------------------"
print "test 93"
print "------------------------------------"
ei_n3628=EI(7.16039E-05,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC3628 halo, vmekal+pow, test93",0.1,0.01,0.3,0.331452)
ei_n3628=EI(2.46909E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628 core, vraym+pow, test93",0.1,0.01,0.3,0.497376)
print "------------------------------------"
print "test 98"
print "------------------------------------"
ei_n3628=EI(7.16797E-05,d_n3628_mpc,3.0,3.0,z_n3628,"NGC3628 halo, vmekal+pow, grp, test98",0.1,0.01,0.3,0.33)
ei_n3628=EI(3.49790E-06,d_n3628_mpc,0.25,0.25,z_n3628,"NGC3628 core, vraym+pow, grp, test98",0.1,0.01,0.3,0.50)
print "------------------------------------"
ei_n3628=EI(3.56274E-04,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC3628, r=3arcmin",0.1,0.01,0.3,0.577)
ei_n3628=EI(2.33972E-04,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC3628, r=0.25arcmin",0.1,0.01,0.3,0.6)
print "------------------------------------"
print "test 86"
print "------------------------------------"
ei_n3628=EI(1.08433E-04,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC3628, r=3arcmin, vmekal",0.1,0.01,0.3,0.30)
ei_n3628=EI(6.06550E-05,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC3628, r=0.25arcmin, vmekal, not correct",0.1,0.01,0.3,0.45)

print "------------------------------------"
print "test 100"
print "------------------------------------"
#ei_n3628=EI(7.48473E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo, vapec+pow, grp, test100",0.1,0.01,0.3,0.33)
ei_n3628=EI(7.17317E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo, vmekal+pow, grp, test100",0.1,0.01,0.3,0.32)
...
ei_n3628=EI(2.46195E-06,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core, vraym+pow, grp, test100",0.1,0.01,0.3,0.58)
print "------------------------------------"
#print "test 100+"
#print "------------------------------------"
...
#print "------------------------------------"
ei_n2146=EI(3.56274E-04,d_n2146_mpc,0.4,0.4,z_n2146,"NGC2146 core (0.4arcm), vraym+pow, grp, test20",0.1,0.01,0.3,0.577)
ei_n2146=EI(3.56274E-04,d_n2146_mpc,0.4,0.4,z_n2146,"NGC2146 halo (2arcm), vraym+pow, grp, test19",0.1,0.01,0.3,0.577345)
ei_n2146=EI(2.51542E-04,d_n2146_mpc,0.5,0.5,z_n2146,"NGC2146 core (0.5) re-fit 20110514, vmekal+pow, grp, test28",0.1,0.01,0.3,0.582138)
ei_n2146=EI(3.12928E-04,d_n2146_mpc,0.5,0.5,z_n2146,"NGC2146 core (0.5) re-fit 20110514, vraymond+pow, grp, test28",0.1,0.01,0.3,0.62635)
print "------------------------------------"
