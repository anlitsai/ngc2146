...
# change fitting model to 2 temperature model, as Hironori suggested.
...
k_B=1.3806505e-16	# [erg/K]	# boltzmann constant
ev_kB=ev/k_B	# [K]
ev_erg=ev	# [erg]
kev_erg=ev*1000	# [erg]
...
#  ------------------------------------	#
# estimate v_plm
def vplm(kT_kev,type):
	kT_erg=kT_kev*kev_erg
	v=math.sqrt(3*kT_erg/(0.5*m_p))
	v_kms=v/100000
	print "T = ", '%.2f' %kT_kev, "[keV] = ", '%.2e' %kT_erg, "[erg] | v_plm = ",'%.2f'  %v_kms, "[km/s] | ", type
	return v_kms
print "------------------------------------"
print "estimate v_plm_kms"
print "------------------------------------"
v_plm_kms_n3628_halo1=vplm(0.21,"halo @high temp")
v_plm_kms_n3628_halo2=vplm(0.60,"halo @low  temp")
v_plm_kms_n3628_core1=vplm(0.47,"core @high temp")
v_plm_kms_n3628_core2=vplm(7.29,"core @low  temp")
print "------------------------------------"
...
#	n_e=math.sqrt(ei/Vf)
	...
	Et1=E1/eff_thrm
	Et2=E2/eff_thrm
	v_rel_kms=abs(v_mol_kms-v_plm_kms)
...
print "------------------------------------"
print "test 86 - Hironori - 2 temperature model for ngc 3628"
# EI(norm, d_mpc, r_maj_arcmin,r_min_arcmin, z ,note,filling1,filling2,eff_thrm,kT_kev,v_mol_kms, v_plm_kms):
print "------------------------------------"
#ei_n3628=EI(12.48E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo norm1 kT1, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,0.11,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(8.28E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo norm2 kT2, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,0.39,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(7.78E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo norm1 kT1, vapec+vapec, grp, test86",filling1,filling2,effi_thm,0.13,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(10.28E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo norm2 kT2, vapec+vapec, grp, test86",filling1,filling2,effi_thm,0.40,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(1.05E-05,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core norm1 kT1, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,0.46,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(2.16E-05,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core norm2 kT2, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,7.05,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(0.64E-05,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core norm1 kT1, vapec+vapec, grp, test86",filling1,filling2,effi_thm,0.54,v_mol_n3628_kms,v_plm_kms)
#ei_n3628=EI(2.17E-05,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core norm2 kT2, vapec+vapec, grp, test86",filling1,filling2,effi_thm,6.64,v_mol_n3628_kms,v_plm_kms)
#print "------------------------------------"
#print "test 86 - Hironori - 2 temperature model for ngc 3628 (part 2)"
print "------------------------------------"
ei_n3628=EI(8.52E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo norm1 kT1, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,0.21,v_mol_n3628_kms,v_plm_kms_n3628_halo1)
ei_n3628=EI(4.63E-05,d_n3628_mpc,3,3,z_n3628,"NGC3628 halo norm2 kT2, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,0.60,v_mol_n3628_kms,v_plm_kms_n3628_halo2)
ei_n3628=EI(0.47E-05,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core norm1 kT1, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,0.47,v_mol_n3628_kms,v_plm_kms_n3628_core1)
ei_n3628=EI(2.18E-05,d_n3628_mpc,0.3,0.3,z_n3628,"NGC3628 core norm2 kT2, vmekal+vmekal, grp, test86",filling1,filling2,effi_thm,7.29,v_mol_n3628_kms,v_plm_kms_n3628_core2)

print "------------------------------------"
print "end test 86 - Hironori - 2 temperature model for ngc 3628"
print "------------------------------------"
