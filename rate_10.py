...
S_TnonT_m82_100GHz_intef=0.43	# [Jy] @100GHz; (Matsushita 2005)
S_TnonT_m82_100GHz_single=0.54	# [Jy] @88GHz; (Jura et al. 1978)
...
S_T_m82_100GHz_single=ttl2thrm(S_TnonT_m82_100GHz_single,freq_m82_100GHz,"M82 thermal Flux density @(100GHz, single dish) = ")
...
L_T_m82_100GHz_single=Lun(d_m82_mpc,S_T_m82_100GHz_single,"M82 L(thermal) @(100GHzsingle dish) = ")
...
print
dN_uv_m82_jura_single=dN_uv(freq_m82_100GHz,L_T_m82_100GHz_single,"M82 single dish (Jura 1978)")
...
def SFR_IR_K(L_IR,type):
	...
	return sfr
print "-----------------------------------------------"
print " SFR_IR=4.5e-44*L_IR (starburst 10-100Myr >5Msun) (Kennicut 1998) "
print "-----------------------------------------------"
SFR_IR_K_m82=SFR_IR_K(L_IR_m82,"M82 SFR (FIR) (data)")
SFR_IR_K_n253=SFR_IR_K(L_IR_n253,"NGC 253 SFR(>5Msun) (IR) (data)")
...
def SFR_dN_uv(dN_uv,sfr_g_IR_C_5m,type):
	...
	return sfr_sbr
print "-----------------------------------------------"
print " SFR_dN_uv(>5Msun)=1/3.5e53*dN_uv (Condon 1992) "
print "-----------------------------------------------"
...
SFR_Radio_m82=SFR_radio5m(L_T_m82_100GHz_intef,freq_m82_100GHz,"M82 radio interferometer")
...
SFR_radio_m82_5M_jura_single=SFR_radio_5Msun(L_T_m82_100GHz_single,freq_m82_100GHz,"M82 SFR (radio interferometer) (>5Msun OB, theory) = ")
