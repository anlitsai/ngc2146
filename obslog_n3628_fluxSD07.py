...
#	b=ssum_ft/ssum_tt
	...
	sig=math.sqrt((ssum_ff-b*ssum_ft)/(n-2))
	sd_error_a=sig*math.sqrt(1/n+ave_t**2/ssum_tt)
	sd_error_b=sig/math.sqrt(ssum_tt)
	uncert_a=sd_error_a/a
	uncert_b=sd_error_b/b
	uncert_ave=sig/ave_f
	uncert_1=sig/(a+b*array_d1[0])
	uncert_2=sig/(a+b*array_d1[3])
...
#	print type, "| n =", n, "| a =", '%.5f' %a,"| b =", '%.3f' %b
	...
	print "         | uncert_a =",'%.5f' %uncert_a, "| uncert_b =",'%.5f' %uncert_b
	print "         | ssum_ff =",'%.3f' %ssum_ff, "| ssum_tt =",'%.3f' %ssum_tt, "| ssum_ft =",'%.3f' %ssum_ft
	print "         | sig =", '%.3f' %sig, " sig_f =",'%.3f' %sig_f, "| sig_t =",'%.3f' %sig_t
#	print "         | sigma =",'%.3f' %sigma, "| sigma_t =",'%.5f' %sigma_t, "| sigma_b =",'%.3f' %sigma_b
	print "         | d2 =",'%.3f' %d2, "| gamma =", '%.3f' %gamma
	print "         | sum_f =",'%.3f' %sum_f, "| sum_t =",'%.3f' %sum_t
	print "         | ave_f =",'%.3f' %ave_f, "| ave_t =",'%.3f' %ave_t
	print "         | uncert_ave =",'%.3f' %uncert_ave, "| uncert_1 =",'%.3f' %uncert_1, "| uncert_2 =",'%.3f' %uncert_2
