...
#def surf_den_kin(v_kms,r_kpc,m_Msun,name):
def surf_den_kin(m_Msun,r_kpc,name):
#	v=v_kms*1.0e5
	r=r_kpc*kpc2cm
	m_kin=m_Msun*M_sun
	sd_kin=m_kin/(math.pi*r**2)
#	sd_kin=v**2/(r*G)
	sd_kin_Msunpc2=sd_kin/Msun_pc2
	print name,"ttl.surf.mass den.=",'%.2f' %(sd_kin_Msunpc2),"[M_sun/pc^2] (z <",r_kpc,"kpc)"
	return sd_kin
sd1=surf_den_kin(m1,r1,n2146)
sd2=surf_den_kin(m2,r2,n2146)
sd3=surf_den_kin(m3,r3,n2146)
sd4=surf_den_kin(m4,r4,n2146)
sd5=surf_den_kin(m5,r5,n2146)
sd6=surf_den_kin(m6,r6,n2146)
sd7=surf_den_kin(m7,r7,n2146)
sd8=surf_den_kin(m8,r8,n2146)
sd9=surf_den_kin(m9,r9,n2146)
# ---------------------------------------------	#
