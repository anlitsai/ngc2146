...
v_motf_kms=90.0 # km/s (Tsai et al. 2009)
v_sound_kms=1.0e3
...
print "M_xotf=",M_xotf,"M_xotf_Inui=",M_xotf_Inui
...
def surf_den_skmt99(S_CO_JyBmMS,px,type):
	...
	print '%.1e' %sd,"[g/cm2]",'%.0f' %sd_Msunpc2,"[Msun/pc2] (z =",'%.2f' %(z_gas_pc),"pc)", '%.2e' %S_CO, "[Jy km/s]" ,'%.1e' %M_gas_Msun,"[Msun]",type
...
# ------------
print "------------"
sd=surf_den_skmt99(4.019E+04,5101,"n3628 core")
sd=surf_den_skmt99(5.232E+04,3081,"n3628 core")
sd=surf_den_skmt99(6.668E+04,1563,"n3628 core")
sd=surf_den_skmt99(8.643E+04,628,"n3628 88GHz")
print "sd [g/cm2], sd_Msunpc2 [Msun/pc2] (z [pc]), S_CO [Jy km/s] ,M_gas_Msun [Msun], type"
print "------------"
...
print "------------"
print "+[ grav P = 2*pi*G*(surf_den_1)*(surf_den_2_dynamical_mass) ]+"
def p_grav(sd,type):
	gravP=2*math.pi*G*sd*sd_dyn_Msunpc2*Msun_pc2
	print " o", type, "grav P:", '%.1e' %(gravP)
	print "   ", '%.1e' %sd, '%.1e' %(sd_dyn_Msunpc2*Msun_pc2)
	return gravP

p_grav_motf=p_grav(sd_motf,"mol. outflow | ngc3628")
p_grav_xotf=p_grav(sd_xotf, "xray outflow | ngc3628")
# unit checked
...
def ramP(effi_x1,effi_x2,type1,type2):
	...
	print "    v_xry = ",  '%.2f' %(v_xry_kms), "[km/s]  ( ==> v_plm ) "
...
gg=980.0
h=0.45*kpc
p_plm_th1=1.28e-10*f1**-0.5
p_plm_th2=1.28e-10*f2**-0.5
