...
E_xotf_n3628=1.0e54 # (chandra archive)
...
sd=surf_den_skmt99(1.364E+04,30695,as2pc_n2146,"tvbox;30as")
...
p_ram1=ramP(E_xotf_n2146,v_motf_kms_n2146,M_xotf_n2146,rho_xotf_n2146,"thermalization efficiency =",0.3,type2,1)
...
p_ram1=ramP(E_xotf_n2146,v_motf_kms_n2146,M_xotf_n2146,rho_xotf_n2146,"starburst energy injection rate (thick-disk, lower) =",0.05,type2,3)
p_ram1=ramP(E_xotf_n2146,v_motf_kms_n2146,M_xotf_n2146,rho_xotf_n2146,"starburst energy injection rate (thick-disk, upper) =",0.2,type2,3)
print "------------"
print "NGC 3628: the total energy released by SNe and stellar winds (doesn't include the K.E)"
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"thermalization efficiency (lower) =",0.1,type2,1)
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"thermalization efficiency =",0.3,type2,1)
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"thermalization efficiency =",0.5,type2,1)
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"thermalization efficiency (upper) =",1,type2,1)
print "------------"
print "NGC 3628: radiating the mechanical energy supplied by the starburst"
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"starburst energy injection rate (thin-disk) =",0.01,type2,10)
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"starburst energy injection rate (thick-disk, lower) =",0.05,type2,3)
p_ram1=ramP(E_xotf_n3628,v_motf_kms_n3628,M_xotf_n3628,rho_xotf_n3628,"starburst energy injection rate (thick-disk, upper) =",0.2,type2,3)
