...
sd=surf_den_skmt99(1.429E+03,84370,"motf")
sd=surf_den_skmt99(7.481E+02,46830,"motf")
sd=surf_den_skmt99(1.327E+03,69990,"motf")
sd=surf_den_skmt99(6.669E+02,57300,"motf")
...
sd=surf_den_skmt99(2.054E+04,186790,"mdsk")
sd=surf_den_skmt99(2.111E+04,180400,"mdsk")
sd=surf_den_skmt99(3.730E+03,53030,"mbbl")
sd=surf_den_skmt99(4.769E+04,15770,"0.3kpc")
sd=surf_den_skmt99(3.523E+04,38770,"0.5kpc")
sd=surf_den_skmt99(3.356E+04,64050,"0.8kpc")
sd=surf_den_skmt99(3.652E+04,54540,"0.8kpc")
sd=surf_den_skmt99(3.049E+04,93940,"1.2kpc")
sd=surf_den_skmt99(2.431E+04,128520,"1.2kpc")
sd=surf_den_skmt99(2.139E+04,166460,"1.6kpc")
sd=surf_den_skmt99(1.723E+04,214640,"1.6kpc")
sd=surf_den_skmt99(1.579E+04,256930,"2.4kpc")
sd=surf_den_skmt99(1.381E+04,301520,"2.4kpc")
sd=surf_den_skmt99(1.466E+04,281700,"2.4kpc")
sd=surf_den_skmt99(1.364E+04,306950,"2.8kpc")
sd=surf_den_skmt99(1.364E+04,306950,"tvbox;30as")
...
def mass(S_Jy_ms,lamb_cm,px,D_Mpc,region):
	...
	A_pc2=A_cm2/pc**2
	m=surfden*A_pc2
	print '%.2e' %surfden,"[Msun/pc2]", '%.2e' %m,"[Msun]",region
	return surfden
