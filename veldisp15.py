...
beta=0.32
gamma=256.39
sd_mdsk=0.00144		# data	# pressure14.py	
sd_mdsk_Msunpc2=6.9	# data	# pressure14.py
sd_dyn_3500pc_Msunpc2=3700	# rotcur01.py
sd_dyn_3500pc=sd_dyn_3500pc_Msunpc2*Msun_pc2
sd_data_dsk1kpc_Msunpc2=400	# rotcur01.py
sd_data_dsk1kpc=sd_data_dsk1kpc_Msunpc2*Msun_pc2	# rotcur01.py
sd_dyn_1kpc_Msunpc2=400	# rotcur01.py
sd_dyn_1kpc=sd_dyn_1kpc_Msunpc2*Msun_pc2	# rotcur01.py
#sd_galdsk=2.09e-2		# rotcur05.py
...
def z0(dispv_z):
        z_pc=((dispv_z*1.0e5)**2/(2*math.pi*g_cgs*sd_dyn_1kpc))/pc2cm
	return z_pc
