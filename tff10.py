...
N_ostar_m82=8.51e4	# re-measured from satoki 2005 data; (Matsushita et al. 2005)
print "============"
print "NGC 2146"
print "============"
print "parameters"
...
def tff_max(M_dyn_msun,M_of_msun,E_kin_mof,E_th_plm,N_ostar,effi_ostar,z1_kpc,v1_kms, v_rot_kms,r_rot_kpc, type):
	...
	v_rot=v_rot_kms*1.0e5
	r_rot=r_rot_kpc*kpc
	v_go=math.sqrt(2*(E_kin_mof+E_th_plm+E_kin_o)/M_of)
	v_go_kms=v_go/1.0e5
	v_go2=0.5*v_go**2
	Phi1=-GM/z_now
...
print "--- N2146 ------------------------"
tff_n2146_myr=tff_max(M_dyn_msun_n2146,M_mof_msun_n2146,E_kin_mof_n2146,E_th_plm_n2146,N_ostar_n2146,effi_ostar,z2_mof_kpc_n2146,v_mof_kms_n2146,v_rot_HI_kms_n2146,r_rot_HI_kpc_n2146, "ngc2146 OF (M) |")
tff_max(M_dyn_msun_n2146,M_mof_msun_n2146,E_kin_mof_n2146,1.3e55,N_ostar_n2146,effi_ostar+0.05,z2_mof_kpc_n2146,v_mof_kms_n2146,v_rot_HI_kms_n2146,r_rot_HI_kpc_n2146, "ngc2146 OF (U) |")
tff_max(M_dyn_msun_n2146,M_mof_msun_n2146,E_kin_mof_n2146,0.4e55,N_ostar_n2146,effi_ostar-0.050,z2_mof_kpc_n2146,v_mof_kms_n2146,v_rot_HI_kms_n2146,r_rot_HI_kpc_n2146, "ngc2146 OF (L) |")
print "---------------------------"
tff_max(M_dyn_msun_n2146,M_sb1_msun_n2146,E_kin_sb1_n2146,0.4e55,N_ostar_n2146,effi_ostar-0.050,z2_mof_kpc_n2146,v_mof_kms_n2146,v_rot_HI_kms_n2146,r_rot_HI_kpc_n2146, "ngc2146 OF (L) |")
print "---------------------------"
print "--- N3628 ------------------------"
tff_n3628_myr=tff_max(M_dyn_msun_n3628,M_mof_msun_n3628,E_kin_mof_n3628,E_th_plm_n3628,N_ostar_n3628,effi_ostar,z2_mof_kpc_n3628,v_mof_kms_n3628, v_rot_HI_kms_n3628,r_rot_HI_kpc_n3628,"ngc3628 OF (M) |")
tff_max(M_dyn_msun_n3628,M_mof_msun_n3628,2.8e54,2.3e53,N_ostar_n3628,effi_ostar+0.05,z2_mof_kpc_n3628,100, v_rot_HI_kms_n3628,r_rot_HI_kpc_n3628,"ngc3628 (U) |")
tff_max(M_dyn_msun_n3628,M_mof_msun_n3628,1.8e54,0.7e53,N_ostar_n3628,effi_ostar-0.05,z1_mof_kpc_n3628,80, v_rot_HI_kms_n3628,r_rot_HI_kpc_n3628,"ngc3628 (L) |")
print "---------------------------"
#  --------------------------------------------	#
...
def tff_z(E_kin_mof,E_th_plm,N_ostar,effi_ostar,M_mof_msun,M_dyn_msun,z_kpc,z0_kpc):
	...
	M_dyn=M_dyn_msun*Msun
	E_tot=E_kin_mof+E_th_plm+E_kin_o
...
#	v_E=v_E_kms*1.0e5
	...
	z=z_kpc*kpc
	z0=z0_kpc*kpc
	z_max=1/(1/z-2*E_tot/M_mof/(math.sqrt(2)*G*M_dyn))
	z_half=(z0+z_max)/2
	z_half_kpc=z_half/kpc
	z_max_kpc=z_max/kpc
	g_z=G*M_dyn/(math.sqrt(2)*z**2)
	g_zmax=G*M_dyn/(math.sqrt(2)*z_max**2)
	g_z0=G*M_dyn/(math.sqrt(2)*z0**2)
	g_zhalf=G*M_dyn/(math.sqrt(2)*z_half)
	g_zhalf_2=(g_z0+g_zmax)/2
	t1=z_max/g_zhalf
	t1_myr=t1/Myr
	t2=z_max/g_z0
	t2_myr=t2/Myr
...
#	print g, g0,'%.2e' %g_1pc
	print "zhalf_kpc",'%.2e' %z_half_kpc, "[kpc]"
	print "zmax_kpc",'%.2e' %z_max_kpc, "[kpc]"
	print "g_zhalf",'%.2e' %g_zhalf, "[cm/s2]"
	print "g_z0",'%.2e' %g_zmax, "[cm/s2]"
	print "g_z0",'%.2e' %g_z0, "[cm/s2]"
	print "return timescale",'%.2e' %t1_myr, "[Myr]"
	print "return timescale",'%.2e' %t2_myr, "[Myr]"
...
print "--- N3628 ------------------------"
tff_z(E_kin_mof_n3628,E_th_plm_n3628,0,0,M_mof_msun_n3628,M_dyn_msun_n3628,0.45,0.01)
...
print "--- N3628 ------------------------"
t_cons(M_SBR_msun_n2146,4.1,tff_n3628_myr,tff_100,SFR_msunyr_n3628,"| N3628")
t_cons(M_SBR_msun_n2146,8.4,tff_n3628_myr,tff_100,SFR_msunyr_n3628,"| N3628")
print "---------------------------"
...
print "--- N3628 ------------------------"
t1_cons_n3628=t_cons2(M_SBR_msun_n2146,4.1,SFR_msunyr_n3628,"| N3628")
t2_cons_n3628=t_cons2(M_SBR_msun_n2146,8.4,SFR_msunyr_n3628,"| N3628")
