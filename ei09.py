...
ei_n3628=EI(6.28310E-05,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC 3628 halo, vmekal+pow, test76",0.1,0.01,0.3,0.372)
ei_n3628=EI(7.16039E-05,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC 3628 halo, vmekal+pow, test93",0.1,0.01,0.3,0.33)

print "------------------------------------"
print "test 93"
print "------------------------------------"
ei_n3628=EI(7.16039E-05,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC 3628 halo, vmekal+pow, test93",0.1,0.01,0.3,0.331452)
ei_n3628=EI(2.46909E-06,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC 3628 core, vraym+pow, test93",0.1,0.01,0.3,0.497376)
print "------------------------------------"
print "test 98"
print "------------------------------------"
ei_n3628=EI(7.16797E-05,d_n3628_mpc,3.0,3.0,z_n3628,"NGC 3628 halo, vmekal+pow, grp, test98",0.1,0.01,0.3,0.33)
ei_n3628=EI(3.49790E-06,d_n3628_mpc,0.25,0.25,z_n3628,"NGC 3628 core, vraym+pow, grp, test98",0.1,0.01,0.3,0.50)
print "------------------------------------"
ei_n3628=EI(3.56274E-04,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC 3628, r=3arcmin",0.1,0.01,0.3,0.577)
ei_n3628=EI(2.33972E-04,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC 3628, r=0.25arcmin",0.1,0.01,0.3,0.6)
print "------------------------------------"
print "test 86"
print "------------------------------------"
ei_n3628=EI(1.08433E-04,d_n3628_mpc,r_maj_halo_n3628_arcmin,r_min_halo_n3628_arcmin,z_n3628,"NGC 3628, r=3arcmin, vmekal",0.1,0.01,0.3,0.30)
ei_n3628=EI(6.06550E-05,d_n3628_mpc,r_maj_core_n3628_arcmin,r_min_core_n3628_arcmin,z_n3628,"NGC 3628, r=0.25arcmin, vmekal, not correct",0.1,0.01,0.3,0.45)
