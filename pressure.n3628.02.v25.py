...
v_motf_kms=50.0 # km/s (Tsai et al. 2009)
v_sound_kms=1.0e3
T_mol=30.0 # K (Tsai et al. 2009)
T_xotf=1.0e6 # K
EI=1.14e61 # cm^-3 (Inui et al. 2005)
R_xotf_pc=350 # (Inui et al. 2005)
...
SFR=3.8 # Msun/yr (Greve et al. 2000)
...
print bm2as2,bm2px
R_starburst_pc=350.0 # (@tau=1# Thompson et al. 2005)
...
sd=surf_den_skmt99(3.085E+04,9308,as2pc,"89GHz region; 2 sigma; 1.4kpc(?)")
sd=surf_den_skmt99(3.095E+04,9239,as2pc,"89GHz region; 2 sigma; 1.4kpc(?)")
