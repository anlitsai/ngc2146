...
print, radi,vexp,texp,mass,Ekin,dm
...
print, "correlate^2","correlate"
print,"R^2 r-V",correlate(radi,vexp)^2,correlate(radi,vexp)
print,"R^2 V-r",correlate(vexp,radi)^2,correlate(vexp,radi)
...
print,"R^2 t-dM",correlate(texp,dm)^2,correlate(texp,dm)
print,"R^2 t-R",correlate(texp,radi)^2,correlate(texp,radi)
print,"R^2 SFR-dM",correlate(sfr,dm)^2,correlate(sfr,dm)
print

;print,"fit", linfit(radi,vexp)
print
