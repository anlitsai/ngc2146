...
freq_m82_88GHz=100.884	# Kotaro's data
...
S_TnonT_n3628_88GHz=1.31e-1	# [Jy] @88 GHz ; from Kotaro's data 88 GHz ; see file '/iapetus/data/satoki_data/ngc3628/rms.3628.conti'
S_TnonT_n2146_88GHz=1.73e-1	# [Jy] @88 GHz ; from Nakanishi's data 88 GHz ; see file '/iapetus/data/satoki_data/ngc2146/tvstat'
S_TnonT_m82_88GHz_intef=0.43	# [Jy] @100GHz; (Matsushita 2005)
S_TnonT_m82_88GHz_single=0.54	# [Jy] @100GHz; (Matsushita 2005)
...
S_T_m82_88GHz_intef=ttl2thrm(S_TnonT_m82_88GHz_intef,freq_m82_88GHz,"M82 thermal Flux density @(88GHz, interferometer, 10Mpc) = ")
S_T_m82_88GHz_single=ttl2thrm(S_TnonT_m82_88GHz_single,freq_m82_88GHz,"M82 thermal Flux density @(88GHz, single dish, 10Mpc) = ")
...
L_T_m82_88GHz_intef=Lun(d_m82_mpc,S_T_m82_88GHz_intef,"M82 L(thermal) @(100GHz, interferometer, 3.2Mpc) = ")
L_T_m82_88GHz_single=Lun(d_m82_mpc,S_T_m82_88GHz_single,"M82 L(thermal) @(100GHzsingle dish, 3.2Mpc) = ")
...
def N_uv(freq_GHz,L_thrm,type):
	...
	print "---",type,"---"
	print "production rate = ", '%.1e' %N_uv, "[photon/s]"
	print "# of O7V-type stars = ", '%.1e' %n_O7Vstar
	print "# of O-type stars = ", '%.1e' %n_Ostar
	return N_uv
...
N_uv_m82_satoki_intef=N_uv(freq_m82_88GHz,L_T_m82_88GHz_intef,"M82 interferometer (satoki 2005)")
N_uv_m82_satoki_single=N_uv(freq_m82_88GHz,L_T_m82_88GHz_single,"M82 single dish (satoki 2005)")
...
SFR_radio_m82_5M_satoki_intef=SFR_radio_5Msun(L_T_m82_88GHz_intef,freq_m82_88GHz,"M82 SFR (radio interferometer) (>5Msun OB, theory) = ")
SFR_radio_m82_5M_satoki_single=SFR_radio_5Msun(L_T_m82_88GHz_single,freq_m82_88GHz,"M82 SFR (radio interferometer) (>5Msun OB, theory) = ")
