...
I_CO_mdsk_1200pc_as2=30.5/(93940*0.04)	# (Tsai et al. 2009)	# file flux.imstat
I_CO_mdsk_800pc_as2=33.6/(64050*0.04)	# (Tsai et al. 2009)	# file flux.imstat
I_CO_mdsk_2400pc_as2=13.8/(301520*0.04)	# (Tsai et al. 2009)	# file flux.imstat
...
z_starburst_pc=15.0	# (our calculation) (iapetus:/iapetus/thesis/phd/calculation/veldisp13.sh)
...
surf_den_galdsk_Msunpc2=100.0
surf_den_galdsk=surf_den_galdsk_Msunpc2*Msun_pc2
#surf_den_dyn_3kpc_Msunpc2=3700.0
surf_den_dyn_3kpc_Msunpc2=1200.0
surf_den_dyn_3kpc=surf_den_dyn_3kpc_Msunpc2*Msun_pc2
surf_den_dsk_1kpc_Msunpc2=400.0
surf_den_dsk_1kpc=surf_den_dyn_3kpc_Msunpc2*Msun_pc2
...
def surf_den_CO_Msunpc2(I_CO_as2):
	I=6.5e2*I_CO_as2/sin_i
	return I

def surf_den_CO(I_CO_as2):
	I=6.5e2*I_CO_as2*(M_sun/pc2cm**2)/sin_i
	return I
...
print "surf_den_galdsk =", '%.2f' %(surf_den_galdsk_Msunpc2), "[Msun/pc^2]"
print "surf_den_galdsk =", '%.2e' %(surf_den_galdsk), "[g/cm^2]"

print "------------"
print "calculation results"
print "------------"
print "+[ grav P = 2*pi*G*(surf_den_xry)*(surf_den_dynamical_mass) ]+"
#print "+[ grav P = 2*pi*G*(surf_den_xry)*(surf_den_gal_disk) ]+"
def p_grav(surf_den,type):
	gravP=2*math.pi*G*surf_den*surf_den_dyn_3kpc
#	gravP=2*math.pi*G*surf_den*surf_den_galdsk
	print " o", type, "grav P:", '%.2e' %(gravP)
	return gravP

p_grav_motf=p_grav(surf_den_motf,"mol. outflow")
p_grav_xotf=p_grav(surf_den_xotf, "xray outflow")
# unit checked
...
E_init=E_xotf_erg
n_ambi=n_mol
print "V_conti",'%.2e' %(V_conti),"[pc^3]"
print "V_greve1",'%.2e' %(V_greve1),"[pc^3]"
print "V_greve2",'%.2e' %(V_greve2),"[pc^3]"
