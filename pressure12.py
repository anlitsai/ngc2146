...
p_grav_motf=p_grav(surf_den_motf,surf_den_HI)
p_grav_xotf=p_grav(surf_den_xotf,surf_den_HI)
...
print " o xray outflow grav P: ",  '%.2e' %(p_grav_xotf)
print " o mol. outflow grav P: ",  '%.2e' %(p_grav_motf)
...
def ramP(effi_x_thrm,effi_x_mech):
	...
	return p
# unit checked
p_ram1=ramP(0.1,0.01)
p_ram1=ramP(0.3,0.01)
p_ram1=ramP(1.0,0.01)
p_ram1=ramP(1.0,0.1)
p_ram1=ramP(0.3,0.1)
p_ram1=ramP(0.1,0.1)
...
p_SNhot_conti=p_SNhot(V_conti)
p_SNhot_greve1=p_SNhot(V_greve1)
p_SNhot_greve2=p_SNhot(V_greve2)
